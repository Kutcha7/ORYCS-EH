...
class Weather{
	...
	public:
        ...
        //Public parameters
		int daynumber;                                      //!< number of day in a year
		...
		double atmP_hPa;		 				            //!< P: atmospheric pressure [hPa]
		double atmP_kPa;						            //!< P: atmospheric pressure [kPa]

		double gradVP;							            //!< s,delta: gradient of vapour pressure [kPa/°C]
		double latHeat_J;						            //!< lambda: latent heat of vapourisation of water [MJ/kg]
		double latHeat_W;						            //!< (W/m²)/(mm/d)
		double satVP;							            //!< es: saturated vapour pressure [kPa]
		double psyConst;						            //!< gamma: psychrometric constant [kPa/°C]
        ...
        /****************************************************************************************//**
         * \brief calculate temperature dependent general parameters
         * \param year current year;
         * \param day current day;
         *******************************************************************************************/
		void generalParameters(int year, int day);
};
